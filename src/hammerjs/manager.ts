...
import  Hammer, { IHammerJSOptions, Recognizers }  from './hammer';
...
export default abstract class Manager {
  public handlers: any = {};
  public session: any = {};
  public recognizers: Array<any> = [];
  public oldCssProps: any = {};
  public input: Input = undefined;
  public touchAction: TouchAction;
  constructor(public element: HTMLElement, public options: IHammerJSOptions) {
    ...
    each(this.options.recognizers, (item: any) => {
   ...
   */
  public add(recognizer: Recognizer): any {
   ...
   * @returns {Manager}
   */
  public remove(recognizer: Recognizer | string) {
  ...
  on(events: string, handler: Function) {
    ...
    let { handlers } = this;
    each(splitStr(events), (event: any) => {
 ...
 * @param {Boolean} add
 */
function toggleCssProps(manager: Manager, add: any) {
  let { element } = manager;
  if (!element.style) {
    return;
  }
  let prop;
  each(manager.options.cssProps, (value: any, name: any) => {
