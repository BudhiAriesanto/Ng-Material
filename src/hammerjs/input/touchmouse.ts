...
export default class TouchMouseInput extends Input {
  ...
  private primaryTouch: any = null ;
  private lastTouches: Array<any> = [];
   ...
   */
  protected handler(manager: Manager, inputEvent: any, inputData: any) {
...
function recordTouches(eventType: any, eventData: any) {
...
function setLastTouch(eventData: any) {
...
function isSyntheticEvent(eventData: any) {
