 ...
 */
angular
  .module('material.components.checkbox', ['ng.material.core'])
    ...
    function postLink(scope, element, attr, ctrls) {
      ...
      function listener(ev) {
        ...
        scope.$apply(function() {
          ...
          const viewValue = attr.ngChecked && attr.ngClick ? attr.checked : !ngModelCtrl.$viewValue;
