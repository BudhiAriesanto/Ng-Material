 ...
 */
angular
    .module('material.components.button', [ 'ng.material.core' ])
 ...
 * </hljs>
 */
MdButtonDirective.$inject = ['$mdButtonInkRipple', '$mdTheming', '$mdAria', '$mdInteraction', '$mdCheckboxInkRipple'];
function MdButtonDirective($mdButtonInkRipple, $mdTheming, $mdAria, $mdInteraction, $mdCheckboxInkRipple) {
  ...
  function postLink(scope, element, attr) {
    $mdTheming(element);
    if (element.parent().hasClass('toolbar-tools')) {
